...
public class ProgressDrawable extends Drawable {
    ...
    private int colorDefault = Color.WHITE, colorError = Color.BLACK;
    ...
    private void initPath() {
        ...
        pathErrorOne.moveTo(width * 0.5f, width * 1.0f);
        pathErrorOne.lineTo(width * 0.5f, width * 0.0f);
        pm.setPath(pathErrorOne, false);
        lenError = pm.getLength();

        pathErrorTwo = new Path();
        pathErrorTwo.moveTo(width * 1.0f, width * 0.5f);
        pathErrorTwo.lineTo(width * 0.0f, width * 0.5f);
    }
    ...
    public void animError(int color) {
        stage = STAGE_ERROR;
        length = lenError;
